...
public class DatabaseHandler extends SQLiteOpenHelper {
	...
	public void onCreate(SQLiteDatabase db) {
		...
		String CREATE_VACANCY_TABLE = "CREATE TABLE " + TABLE_VACANCY + "("
				+ KEY_ID_VACANCY + " INTEGER PRIMARY KEY," + KEY_NAME_VACANCY + " TEXT,"
				+ KEY_NUMBER_VACANCY + " TEXT," + KEY_COMPANY_VACANCY + " TEXT," 
				+ KEY_DEPARTMENT_VACANCY + " TEXT," + KEY_VACANTCOUNT_VACANCY + " TEXT," 
				+ KEY_APPLICANTCOUNT_VACANCY + " TEXT," + KEY_STATUS_VACANCY + " TEXT" + ")";
	...
	public Login getLogin(int id) {
		...
		Cursor cursor = db.query(TABLE_LOGIN,
				new String[] { KEY_ID_LOGIN, KEY_LOGIN }, KEY_ID_LOGIN + "=?",
	...
	// Add vacancy to the database
		...
		public Vacancy getVacancy(int id) {
			...
			Cursor cursor = db.query(TABLE_VACANCY, new String[] { KEY_ID_VACANCY,
					...
					KEY_DEPARTMENT_VACANCY, KEY_VACANTCOUNT_VACANCY, KEY_APPLICANTCOUNT_VACANCY,
					KEY_STATUS_VACANCY  }, KEY_ID_VACANCY + "=?",
					new String[] { String.valueOf(id) }, null, null, null, null);
			// Reading
			if (cursor != null)
				cursor.moveToFirst();
